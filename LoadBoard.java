...
//			System.out.println(inLine);
			...
			if(inLine.charAt(0)=='b'){		theSign = -1;}
			else if(inLine.charAt(0)=='w'){	theSign = 1;}
			...
			/** This adds the piece to the appropriate piece vector.
			 **
			 ** If the piece is a king its also added to the kings vector.
			 ** Furthermore if a king or rook is encounted its checked to see if
			 ** its in the default position to determine if castling can happen.
			 */
