...
public class EndGamePanel extends JPanel implements ActionListener {
  ...
  /**
   * The End Game Dialog * * The end game dialog will show up once the game is a draw or a mate has
   * * occured. The dialog has three choices on it, "Play". "Save", and "Quit". * Play will start a
   * new game with the AI turned off. Save will save the * list of moves that the game generated.
