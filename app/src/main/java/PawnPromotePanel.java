...
public class PawnPromotePanel extends JPanel implements ActionListener {
  ...
  public PawnPromotePanel() {
    ...
    qIcon =
        new ImageIcon(getClass().getResource("/images/Pieces/" + colour + "Queen.png"), "Queen");
    qHIcon =
        new ImageIcon(getClass().getResource("/images/Pieces/" + colour + "hQueen.png"), "Queen");
    kIcon =
        new ImageIcon(getClass().getResource("/images/Pieces/" + colour + "Knight.png"), "Knight");
    kHIcon =
        new ImageIcon(getClass().getResource("/images/Pieces/" + colour + "hKnight.png"), "Knight");
    rIcon = new ImageIcon(getClass().getResource("/images/Pieces/" + colour + "Rook.png"), "Rook");
    rHIcon =
        new ImageIcon(getClass().getResource("/images/Pieces/" + colour + "hRook.png"), "Rook");
    bIcon =
        new ImageIcon(getClass().getResource("/images/Pieces/" + colour + "Bishop.png"), "Bishop");
    bHIcon =
        new ImageIcon(getClass().getResource("/images/Pieces/" + colour + "hBishop.png"), "Bishop");
