...
public class TurnPanel extends JPanel {
  ...
  public TurnPanel() {
    try {
      ...
      wCheckOn =
          new ImageIcon(
              getClass().getResource("/images/SidePanel/CheckIndicators/wCheckOn.png"),
              "white check");
      wCheckOff =
          new ImageIcon(getClass().getResource("/images/SidePanel/CheckIndicators/wCheckOff.png"));
      bCheckOn =
          new ImageIcon(
              getClass().getResource("/images/SidePanel/CheckIndicators/bCheckOn.png"),
              "black check");
      bCheckOff =
          new ImageIcon(getClass().getResource("/images/SidePanel/CheckIndicators/bCheckOff.png"));
  ...
  public void saveTurns(JFrame owner) {
    try {
      ...
      JOptionPane.showMessageDialog(
          this, "Moves have been saved to file", "Save complete", JOptionPane.INFORMATION_MESSAGE);
    } catch (IOException ex) {
